...
if __name__ == "__main__":
    ...
    FSDATA_FILE_PATH = 'Middlewares/Third_Party/LwIP/src/apps/http/fsdata.c'  # Path to the file
    ...
    try:
        ...
        base_dir = os.path.abspath('Middlewares/Third_Party/LwIP/src/apps/http/fs')
